      ...
      <div class="bg-white rounded-2xl border border-slate-200/90 shadow-2xs hover:shadow-md transition-all duration-200 overflow-hidden flex flex-col group">
        ...
        <div class="p-3 sm:p-4 flex flex-col flex-1 justify-between">
          <div>
            ...
            <div class="flex items-center gap-1 text-amber-500 text-[10px] mt-1 mb-2">
              <span>★★★★★</span>
          ...
          <div class="mt-2 pt-2 border-t border-slate-100">
            ...
            <a href="/produto/${rel.id}" class="mt-2.5 w-full bg-slate-50 hover:bg-rose-50 hover:text-rose-700 hover:border-rose-300 text-slate-700 font-bold text-xs py-1.5 px-2 rounded-xl transition text-center border border-slate-200 block">
              Ver Produto ➔
            </a>
          </div>
        </div>
...
<body class="antialiased selection:bg-rose-100 selection:text-rose-900 min-h-screen flex flex-col">
    ...
    <div class="bg-slate-900 text-white text-xs font-semibold py-2 px-4 text-center border-b border-slate-800">
        <div class="max-w-7xl mx-auto flex items-center justify-between gap-2 flex-wrap sm:flex-nowrap">
            <span class="flex items-center gap-1.5 mx-auto sm:mx-0">
                ...
                <span>⚡ <strong>Entrega expressa em até 45 minutos</strong> para todo o Brasil • Flores frescas selecionadas</span>
            </span>
        ...
        <div class="max-w-7xl mx-auto px-4 py-3 sm:py-4">
            <div class="flex items-center justify-between gap-4">
                ...
                <div class="flex items-center gap-2">
                    <a href="/" class="text-slate-600 hover:text-slate-900 font-bold text-xs sm:text-sm py-2 px-3 rounded-xl border border-slate-200 hover:bg-slate-50 transition flex items-center gap-1">
                        <span>← Catálogo</span>
                    </a>
                    <button onclick="handleProductWpp()" class="bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs sm:text-sm py-2 px-3 sm:px-4 rounded-xl shadow-xs transition flex items-center gap-1.5 cursor-pointer">
    ...
    <div class="bg-white border-b border-slate-100 py-2.5 text-xs text-slate-500">
        <div class="max-w-7xl mx-auto px-4 flex items-center gap-1.5 flex-wrap">
    ...
    <main class="max-w-7xl mx-auto px-4 py-6 sm:py-10 flex-1 w-full">
        <div class="bg-white rounded-3xl border border-slate-200/90 shadow-xs p-4 sm:p-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <div class="grid grid-cols-3 gap-2 text-center text-slate-600 text-xs">
                        <div class="p-2.5 rounded-xl bg-slate-50 border border-slate-100">
                            <span class="text-lg block mb-0.5">📸</span>
                            <span class="font-bold text-[11px] text-slate-800 block">Foto Antes do Envio</span>
                            <span class="text-[10px] text-slate-400">Pelo WhatsApp</span>
                        </div>
                        <div class="p-2.5 rounded-xl bg-slate-50 border border-slate-100">
                            <span class="text-lg block mb-0.5">💌</span>
                            <span class="font-bold text-[11px] text-slate-800 block">Cartão Incluso</span>
                            <span class="text-[10px] text-slate-400">Com sua mensagem</span>
                        </div>
                        <div class="p-2.5 rounded-xl bg-slate-50 border border-slate-100">
                            <span class="text-lg block mb-0.5">🔒</span>
                            <span class="font-bold text-[11px] text-slate-800 block">Garantia Total</span>
                            <span class="text-[10px] text-slate-400">Flores perfeitas</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex flex-col justify-between">
                    <div>
                        ...
                        <div class="flex items-center justify-between gap-2 mb-2">
                            <span class="text-xs font-black uppercase tracking-wider text-rose-600 bg-rose-50 px-2.5 py-0.5 rounded-md">
                                ${catName}
                            </span>
                        ...
                        <!-- Título do Produto -->
                        <h1 class="text-2xl sm:text-3xl font-black text-slate-900 tracking-tight leading-snug mb-2">
                            ${product.title}
                        </h1>
                        ...
                        <div class="flex items-center gap-2 mb-5">
                            ...
                            <span class="text-xs text-slate-400">• 148 avaliações verificadas</span>
                        </div>

                        <!-- Caixa de Preço Principal -->
                        <div class="bg-slate-50/80 p-4 rounded-2xl border border-slate-200 mb-5">
                            <span class="text-xs text-slate-400 line-through font-bold block">
                            ...
                            <span class="text-xs text-slate-600 font-semibold block mt-1">
                                ou em até <strong>3x de R$ ${formatPrice(parcelNum)}</strong> sem juros no cartão
                            </span>
                            <span class="text-[11px] text-emerald-700 font-bold block mt-1">
                                ✓ Desconto especial para pagamento à vista no Pix
                            </span>
                        </div>

                        <!-- Urgência & Prazo de Entrega (A Regra dos 45 Minutos) -->
                        <div class="bg-emerald-50/90 border border-emerald-200 p-4 rounded-2xl mb-5">
                            <div class="flex items-start gap-2.5">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-emerald-800 font-medium mt-0.5 leading-relaxed">
                        ...
                        <div class="bg-white p-4 rounded-2xl border-2 border-slate-200 mb-6 space-y-2">
                            ...
                            <textarea 
                                ...
                                class="w-full bg-slate-50 border border-slate-300 rounded-xl p-3 text-xs sm:text-sm text-slate-800 focus:bg-white focus:border-rose-500 focus:ring-2 focus:ring-rose-100 outline-none transition font-medium placeholder:text-slate-400 resize-none"
                            ></textarea>
                    ...
                    <div class="space-y-2.5 pt-2">
                        ...
                        <button onclick="handleProductWpp()" class="w-full bg-gradient-to-r from-emerald-600 to-green-500 hover:from-emerald-700 hover:to-green-600 text-white font-black py-4 px-6 rounded-2xl shadow-lg shadow-green-600/25 flex items-center justify-center gap-2.5 text-base sm:text-lg transition transform active:scale-98 cursor-pointer">
                            <svg class="w-6 h-6 fill-current shrink-0" viewBox="0 0 16 16"><path d="M13.601 2.326A7.85 7.85 0 0 0 7.994 0C3.627 0 .068 3.558.064 7.926c0 1.399.366 2.76 1.057 3.965L0 16l4.204-1.102a7.9 7.9 0 0 0 3.79.965h.004c4.368 0 7.926-3.558 7.93-7.93A7.9 7.9 0 0 0 13.6 2.326zM7.994 14.521a6.6 6.6 0 0 1-3.356-.92l-.24-.144-2.494.654.666-2.433-.156-.251a6.56 6.56 0 0 1-1.007-3.505c0-3.626 2.957-6.584 6.591-6.584a6.56 6.56 0 0 1 4.66 1.931 6.56 6.56 0 0 1 1.928 4.66c-.004 3.639-2.961 6.592-6.592 6.592m3.615-4.934c-.197-.099-1.17-.578-1.353-.646-.182-.065-.315-.099-.445.099-.133.197-.513.646-.627.775-.114.133-.232.148-.43.05-.197-.1-.836-.308-1.592-.985-.59-.525-.985-1.175-1.103-1.372-.114-.198-.011-.304.088-.403.087-.088.197-.232.296-.346.1-.114.133-.198.198-.33.065-.134.034-.248-.015-.347-.05-.099-.445-1.076-.612-1.47-.16-.389-.323-.335-.445-.34-.114-.007-.247-.007-.38-.007a.73.73 0 0 0-.529.247c-.182.198-.691.677-.691 1.654s.71 1.916.81 2.049c.098.133 1.394 2.132 3.383 2.992.47.205.84.326 1.129.418.475.152.904.129 1.246.08.38-.058 1.171-.48 1.338-.943.164-.464.164-.86.114-.943-.049-.084-.182-.133-.38-.232"/></svg>
        ...
        <div class="mt-12">
            <div class="flex items-center justify-between mb-6">
                <div>
                    <h3 class="text-xl sm:text-2xl font-black text-slate-900">Quem comprou este produto também amou</h3>
                    <p class="text-xs sm:text-sm font-medium text-slate-500 mt-0.5">Sugestões especiais selecionadas para você</p>
                </div>
    ...
    <a href="javascript:void(0)" onclick="handleProductWpp()" class="fixed bottom-5 right-5 z-40 bg-emerald-600 hover:bg-emerald-700 text-white rounded-full p-3.5 shadow-xl wpp-pulse transition transform hover:scale-105 flex items-center justify-center cursor-pointer" title="Falar no WhatsApp">
